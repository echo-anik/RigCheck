...
class CompatibilityController extends Controller
{
    ...
    {
        // Return compatibility rules without requiring a database table
        $rules = [
            [
                'id' => 1,
                'name' => 'CPU-Motherboard Socket Compatibility',
                'category_1' => 'cpu',
                'category_2' => 'motherboard',
                'check_type' => 'socket_match',
            ...
            [
                ...
                'category_1' => 'motherboard',
                'category_2' => 'case',
                'check_type' => 'form_factor_fit',
                'description' => 'Motherboard must fit in the case',
                'severity' => 'error'
            ],
            [
                'id' => 4,
            ...
            [
                ...
                'category_1' => 'gpu',
                'category_2' => 'case',
                'check_type' => 'gpu_clearance',
                'description' => 'GPU must fit in the case',
                'severity' => 'warning'
            ]
        ];
